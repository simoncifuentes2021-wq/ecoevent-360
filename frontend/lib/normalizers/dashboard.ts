...
export function normalizeEventDashboard(raw: unknown): EventDashboard {
  ...
  return {
    ...
    forms: data.forms && typeof data.forms === "object" ? data.forms as Record<string, unknown> : {},
    forms_by_session: Array.isArray(data.forms_by_session) ? data.forms_by_session as EventDashboard["forms_by_session"] : [],
...
export function buildEventDashboardFromFallbackData(data: {
  ...
  return {
    ...
    survey: { total_responses: activeSurveys, average_rating: 0, recommendation_rate: 0, cleaning_average: 0, bathroom_average: 0, main_problems: [], responses_by_zone: [], main_problem: activeSurveys ? "Formularios activos" : "Sin formularios" },
    forms: {},
    forms_by_session: [],
