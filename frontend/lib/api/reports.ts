...
export function applyReportAssistantProposal(reportId: string, generationId: string, editVersion: number, acceptedSectionKeys?: string[], applyPreset = true) { return api.post<{ revision_id: string; report: ReportEditor }>(`/reports/${reportId}/ai-assistant/proposals/apply`, { generation_id: generationId, edit_version: editVersion, accepted_section_keys: acceptedSectionKeys ?? null, apply_preset: applyPreset }); }
