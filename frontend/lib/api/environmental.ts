...
export const interpretEnvironmentalAction = (eventId: string, actionId: string) => api.post<AIEnvironmentalInterpretation>(`/events/${eventId}/environmental-actions/${actionId}/ai-interpretation`, {});
