...
export function ModalShell({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-3 sm:p-4">
      <div className={`${size === "lg" ? "max-w-5xl" : "max-w-xl"} max-h-[90vh] w-full overflow-y-auto overflow-x-hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-2xl sm:p-6`}>
