...
export function PublicFormHeader({ form }: { form: PublicEventForm }) {
  ...
  return (
    <header className="relative isolate min-h-[260px] overflow-hidden bg-slate-900 text-white">
      ...
      <div className="relative mx-auto flex min-h-[260px] max-w-5xl flex-col justify-between px-5 pb-20 pt-6">
