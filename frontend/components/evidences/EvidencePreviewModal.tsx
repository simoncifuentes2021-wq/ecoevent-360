    ...
    <ModalShell title="Vista de evidencia" description={evidence.description || evidence.filename || "Archivo operativo"} onClose={onClose}>
      <div className="space-y-4">
        {isImage ? (
          ...
          <img alt={evidence.description || "Evidencia"} className="max-h-[65vh] w-full rounded-2xl object-contain bg-slate-100" src={evidence.file_url} />
        ) : (
        ...
        <a href={evidence.file_url} rel="noreferrer" target="_blank">
