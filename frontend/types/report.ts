...
export type ReportSectionVisualConfig = { variant: ReportVisualVariant; icon_key?: "LEAF" | "RECYCLE" | "BICYCLE" | "CARBON" | "ENERGY" | "WATER" | "PEOPLE" | "LOCATION" | "CALENDAR" | "CHART" | "CHECK" | "ALERT" | "LIGHTBULB" | "CAMERA" | "TARGET" | null; show_icon: boolean; show_trend: boolean };
export type ReportEditorialConfig = { mode: "AUTO" | "CUSTOM"; cover_style: "FULL_PHOTO" | "SIDE_PHOTO" | "EDITORIAL" | "MINIMAL_PREMIUM"; cover_evidence_id?: string | null; featured_kpi_ids: string[]; page_overrides: Record<string, { mode: ReportPageOverrideMode; group_with?: string | null }>; chart_types: Record<string, "BAR" | "DONUT" | "COMPARISON" | "DISTRIBUTION">; visual_config: ReportVisualConfig; section_visuals: Record<string, ReportSectionVisualConfig> };
