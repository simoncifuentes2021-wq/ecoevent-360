...
for _preset_variants in PRESET_SECTION_VARIANTS.values():
    _preset_variants.update(_PREMIUM_REPORT_VARIANTS)
...
SECTION_ICONS = {
    ...
    "SERVICES": "CHECK", "OPERATIONS": "CHART", "STAFF": "PEOPLE",
